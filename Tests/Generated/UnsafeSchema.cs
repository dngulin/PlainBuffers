...
// Generated at 2020-09-28T20:18:34.2952103+03:00
...
namespace PlainBuffers.Tests.GeneratedUnsafe {
    ...
    public readonly unsafe ref struct Vec {
        ...
        public static Vec CreateSafe(byte* ptr, int bufferSize) {
            if (bufferSize != SizeOf) throw new InvalidOperationException("Buffer size doesn't match to the struct size!");
            return new Vec(ptr);
        }
    ...
    public readonly unsafe ref struct Quat {
        ...
        public static Quat CreateSafe(byte* ptr, int bufferSize) {
            if (bufferSize != SizeOf) throw new InvalidOperationException("Buffer size doesn't match to the struct size!");
            return new Quat(ptr);
        }
    ...
    public readonly unsafe ref struct HandleArray5 {
        ...
        public static HandleArray5 CreateSafe(byte* ptr, int bufferSize) {
            if (bufferSize != SizeOf) throw new InvalidOperationException("Buffer size doesn't match to the struct size!");
            return new HandleArray5(ptr);
        }
    ...
    public readonly unsafe ref struct Monster {
        ...
        public static Monster CreateSafe(byte* ptr, int bufferSize) {
            if (bufferSize != SizeOf) throw new InvalidOperationException("Buffer size doesn't match to the struct size!");
            return new Monster(ptr);
        }
