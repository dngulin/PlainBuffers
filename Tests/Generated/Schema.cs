...
// Generated at 2020-09-22T23:39:35.7108466+03:00
...
namespace PlainBuffers.Tests.Generated {
    ...
    public readonly ref struct Monster {
        ...
        private const int _PaddingStart = 45;
        private const int _PaddingSize = 3;
        ...
        public PlainInt16 Mana => new PlainInt16(_buffer.Slice(28, PlainInt16.SizeOf));
        public PlainInt16 Hp => new PlainInt16(_buffer.Slice(30, PlainInt16.SizeOf));
        public HandleArray5 Inventory => new HandleArray5(_buffer.Slice(32, HandleArray5.SizeOf));
        public PlainBool Alive => new PlainBool(_buffer.Slice(42, PlainBool.SizeOf));
        public PlainBool Aggressive => new PlainBool(_buffer.Slice(43, PlainBool.SizeOf));
        public _PlainColorId Color => new _PlainColorId(_buffer.Slice(44, _PlainColorId.SizeOf));
